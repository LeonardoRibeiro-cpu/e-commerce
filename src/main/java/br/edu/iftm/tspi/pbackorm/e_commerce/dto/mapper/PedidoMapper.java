...
public interface PedidoMapper {
    ...
    DetalhePedidoDTO toDetalheDto(DetalhesPedido detalhe);
    
    @Mapping(source = "idPedido", target = "pedido.id")
    @Mapping(source = "idProduto", target = "produto.id")
    DetalhesPedido toDetalheEntity(DetalhePedidoDTO detalheDto);


    List<DetalhePedidoDTO> toDetalhesDtoList(List<DetalhesPedido> detalhes);
    List<DetalhesPedido> toDetalhesEntityList(List<DetalhePedidoDTO> detalhesDto);
